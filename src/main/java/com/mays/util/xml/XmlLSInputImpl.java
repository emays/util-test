 ...
 * Specification</a>.
 *
 * Quoted the at-sign to avoid a javadoc error
 * "@"xerces.internal
 *
...
public class XmlLSInputImpl implements LSInput {
	...
	public XmlLSInputImpl(String publicId, String systemId, String baseSystemId) {
	...
	public XmlLSInputImpl(String publicId, String systemId, String baseSystemId, InputStream byteStream,
			String encoding) {
	...
	public XmlLSInputImpl(String publicId, String systemId, String baseSystemId, Reader charStream, String encoding) {
	...
	public XmlLSInputImpl(String publicId, String systemId, String baseSystemId, String data, String encoding) {
		fPublicId = publicId;
		fSystemId = systemId;
		fBaseSystemId = baseSystemId;
		fData = data;
